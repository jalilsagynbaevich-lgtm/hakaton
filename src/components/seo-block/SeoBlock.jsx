...
const SeoBlock = () => {
  return (
    <section className="container mx-auto px-4 py-24">
      {/* Контейнер с items-start, чтобы картинка не растягивалась до самого низа фона */}
      <div className="flex flex-col lg:flex-row items-start relative">
        
        {/* 1. КАРТИНКА: Оставляем её сверху (z-20) и уменьшаем ширину до 40% */}
        ...
        {/* 2. КОНТЕЙНЕР ДЛЯ ТЕКСТА: 60% ширины, заезжает под картинку через -ml */}
        <div className="w-full lg:w-[60%] flex flex-col z-10 lg:-ml-20 mt-10 lg:mt-16">
          
          {/* Заголовок: Стоит только над текстовым блоком */}
          ...
          {/* 3. БОЛЬШОЙ БИРЮЗОВЫЙ ФОН: Добавляем pb-32, чтобы он сильно выпирал снизу */}
          <div className="bg-[#48BDB8] text-white p-8 md:p-14 lg:pl-32 pb-24 md:pb-32 rounded-sm shadow-xl">
            
            {/* Текст: Выровнен по левому краю внутри фона */}
